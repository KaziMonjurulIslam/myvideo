...
*/
        ...
        return this.each(function ()
        {
            ...
            html += '    <div class="videocontrols-btn">' +
                    '        <div title="Play/Pause" class="videocontrols-play videocontrols-button vc-icon-play"></div>';
            if (defaults.time) {
                html += '        <div class="videocontrols-time">' +
                        '            <span class="videocontrols-timer">00:00</span><span class="videocontrols-totaltime"></span>' +
                        '        </div>';
            }
            ...
            html += '        </div>' +
                    ...
                    '    <div title="Play Video" class="videocontrols-big-play vc-giant-icon vc-icon-big-play"></div>' +
                    '    <div title="Play Video" class="videocontrols-big-pause vc-giant-icon vc-icon-big-pause" style="display: none;"></div>' +
					'	 <img src="ad.png" height="200px" width="400px"></img>'+
                    '</div>';
            $video.after(html);
